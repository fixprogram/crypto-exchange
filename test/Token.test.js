...
contract("Token", ([deployer, receiver, exchange]) => {
  ...
  describe("sending tokens", () => {
    ...
    describe("failure", async () => {
      it("reject insufficient balances", async () => {
        let invalidAmount;
        invalidAmount = tokens(10000000000); // It's greater than total supply
        await token
  ...
  describe("approving tokens", () => {
    ...
    describe("success", () => {
      it("allocates in allowance for delegated token spending on exchange", async () => {
  ...
  describe("delegated token transfers", () => {
    ...
    describe("failure", async () => {
      it("rejects insufficient amounts", async () => {
        const invalidAmount = tokens(10000000000); // It's greater than total supply
        await token
          .transfer(receiver, invalidAmount, { from: deployer })
          .should.be.rejectedWith(EVM_REVERT);
      });
